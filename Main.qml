...
PlasmaCore.ColorScope {
    ...
    StackView {
        ...
        initialItem: Login {
            ...
            userListModel: customUserListModel
            userListCurrentIndex: customUserListModel.lastIndex >= 0 ? customUserListModel.lastIndex : 0

            Component.onCompleted: {
                customUserListModel.loadUsersFromGroup();
            }
